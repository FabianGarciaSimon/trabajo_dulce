...
class Doctor2Servicios extends Component
{
    public $doctores;
    ...
    public function render()
    {
        ...
        $this->doctores = User::where('role_id', 2)
            ->whereHas('serviciosRegistrados', function ($query) {
                $query->where('doctor_id', 5); // Ajusta el ID del Doctor 1 según tu estructura de base de datos
            })
            ->get();

        return view('livewire.doctor2-servicios');
    }
}
